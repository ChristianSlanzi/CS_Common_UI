...
public extension UIColor {
    ...
    /// - Returns: The light palette color used for the background for standard content.
    class func captionBackground(for theme: Theme) -> UIColor {
        switch theme {
        case .light:
            return Palette.selectedPink
        case .dark:
            return Palette.cannonPurple
        default:
            return Palette.selectedPink
        }
    }
    ...
    ///   - theme: The theme for which to determine the color of the background for standard content.
    /// - Returns: The light palette color used for the background for standard content.
    class func selectedBackground(for theme: Theme) -> UIColor {
        switch theme {
        case .light:
            return Palette.selectedPink
        case .dark:
...
private extension UIColor {
    ...
    struct Palette {
        ...
        static let selectedPink = UIColor(red: 180/255.0, green: 138/255.0, blue: 171/255.0, alpha: 0.5)
    }
}
